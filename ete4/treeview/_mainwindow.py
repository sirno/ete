...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addPixmap(QPixmap(":/ete icons/fileopen.png"), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon1 = QIcon()
        icon1.addPixmap(QPixmap(":/ete icons/filesave.png"), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon2 = QIcon()
        icon2.addPixmap(QPixmap(":/ete icons/show_dist.png"), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon3 = QIcon()
        icon3.addPixmap(QPixmap(":/ete icons/zoom_in.png"), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionZoomIn.setIcon(icon3)
        self.actionZoomIn.setObjectName("actionZoomIn")
        self.actionZoomOut = QAction(MainWindow)
        icon4 = QIcon()
        icon4.addPixmap(QPixmap(":/ete icons/zoom_out.png"), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon5 = QIcon()
        icon5.addPixmap(QPixmap(":/ete icons/force_topo.png"), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon10 = QIcon()
        icon10.addPixmap(QPixmap(":/ete icons/fit_tree.png"), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon11 = QIcon()
        icon11.addPixmap(QPixmap(":/ete icons/fit_region.png"), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon12 = QIcon()
        icon12.addPixmap(QPixmap(":/ete icons/export_pdf.png"), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon13 = QIcon()
        icon13.addPixmap(QPixmap(":/ete icons/search.png"), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon14 = QIcon()
        icon14.addPixmap(QPixmap(":/ete icons/clean_search.png"), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon15 = QIcon()
        icon15.addPixmap(QPixmap(":/ete icons/show_newick.png"), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon16 = QIcon()
        icon16.addPixmap(QPixmap(":/ete icons/show_support.png"), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon17 = QIcon()
        icon17.addPixmap(QPixmap(":/ete icons/show_names.png"), QIcon.Mode.Normal, QIcon.State.Off)
